...
public class registerAndSignInTest {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.email2),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("mfan"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.email2),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("mfan"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.password),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("matt"), closeSoftKeyboard());
