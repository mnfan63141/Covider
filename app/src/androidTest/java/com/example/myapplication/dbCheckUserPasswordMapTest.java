...
public class dbCheckUserPasswordMapTest {
    ...
    public void dbCheckUserPasswordMapTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.fullName),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("Matt Fan"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.email),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("mfan63141@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.map), withText("map"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction materialTextView = onView(
                allOf(withId(R.id.campusCenter), withText("Campus Center"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        if(cursor.getCount()>0){
            while(cursor.moveToNext()){
                if (cursor.getString(2).equals("1234")) {
                    pw = cursor.getString(2);
                }
            }
        }
        Assert.assertEquals("1234", pw);
    }
